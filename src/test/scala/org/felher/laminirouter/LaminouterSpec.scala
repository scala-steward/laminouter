...
object LaminouterSpec extends TestSuite:
  ...
  final private case class Test(
      route: Route,
      url: String
  )

  final private val routesToTest = List(
    ...
    Test(
      Route.MultiParamQuery("user-name", 999)(123, "red"),
      "https://www.heise.de:8080/multiParamQuery/user-name/999?page=123&filter=red"
    ),
    Test(
      Route.MultiParamQueryOptional("user-name", 999)(123, Some("red")),
      "https://www.heise.de:8080/multiParamQueryOptional/user-name/999?page=123&filter=red"
    ),
    Test(
      Route.MultiParamQueryOptional("user-name", 999)(123, None),
      "https://www.heise.de:8080/multiParamQueryOptional/user-name/999?page=123"
    )
  )
